...
-- Seed default pricing (flat rates — no volume discounts)
INSERT INTO public.bot_settings (key, value, label, description) VALUES
  ('drum_price_1',      360, 'Drum Price (€)',            'Price per drum (flat rate)'),
  ('drum_price_2_4',    360, '2–4 Drums Price (€)',       'Price per drum (flat rate, kept for compatibility)'),
  ('drum_price_5_plus', 360, '5+ Drums Price (€)',        'Price per drum (flat rate, kept for compatibility)'),
  ('box_price_1',       220, 'Box Price (€)',              'Price per box (flat rate)'),
  ('box_price_2_4',     220, '2–4 Boxes Price (€)',        'Price per box (flat rate, kept for compatibility)'),
  ('box_price_5_plus',  220, '5+ Boxes Price (€)',         'Price per box (flat rate, kept for compatibility)'),
