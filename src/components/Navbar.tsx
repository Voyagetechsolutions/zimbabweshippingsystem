      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center">
            {/* Add ThemeToggle component here, before user account dropdown */}
            <ThemeToggle />
          ...
          <div className="md:hidden flex items-center">
            {/* Add ThemeToggle component for mobile */}
            <ThemeToggle />
            <button
              onClick={toggleMenu}
              className="inline-flex items-center justify-center p-2 ml-2 rounded-md text-gray-700 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-zim-green"
            >
