    ...
    <div className="bg-white">
      ...
      <section className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 animate-item">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gray-50">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 animate-item">Our Services</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto animate-item">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 flex flex-col items-center text-center animate-item"
            >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-zim-green text-white">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6 animate-item">Ready to get started?</h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto animate-item">
            Join thousands of satisfied customers who trust us with their shipping needs. Book your shipment today!
          </p>
          <Button asChild size="lg" variant="outline" className="bg-white text-zim-green hover:bg-gray-100 animate-item">
