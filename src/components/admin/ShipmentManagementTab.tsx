                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-sm font-mono bg-gray-50 p-2 rounded break-all">{shipment.tracking_number}</p>
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div>
                      ...
                      <div className="text-sm bg-blue-50 p-3 rounded border-l-4 border-blue-500 break-words">
                    ...
                    <div>
                      ...
                      <div className="text-sm bg-green-50 p-3 rounded border-l-4 border-green-500 break-words">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-sm break-words">{senderDetails.firstName || senderDetails.name || 'Not provided'}</p>
                        </div>
                        {senderDetails.email && (
                          <div>
                        ...
                        {senderDetails.phone && (
                          <div>
                            ...
                            <p className="text-sm break-all">{senderDetails.phone}</p>
                          </div>
                        )}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-3">
                        <div>
                          <Label className="text-xs font-medium text-gray-600">Name</Label>
                          <p className="text-sm break-words">{recipientDetails.firstName || recipientDetails.name || 'Not provided'}</p>
                        </div>
                        {recipientDetails.phone && (
                          <div>
                            ...
                            <p className="text-sm break-all">{recipientDetails.phone}</p>
                          </div>
                        )}
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="text-sm break-words">{shipmentDetails.type || 'Not specified'}</p>
                    </div>
                    <div>
                      <Label className="text-sm font-medium text-gray-600">Quantity</Label>
                      <p className="text-sm break-words">{shipmentDetails.quantity || 'Not specified'}</p>
                    </div>
                    <div>
                      <Label className="text-sm font-medium text-gray-600">Category</Label>
                      <p className="text-sm break-words">{shipmentDetails.category || 'Not specified'}</p>
                    </div>
                    <div className="md:col-span-2 lg:col-span-3">
                      <Label className="text-sm font-medium text-gray-600">Description</Label>
                      <div className="text-sm bg-gray-50 p-3 rounded break-words">{shipmentDetails.description || 'Not provided'}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm break-words">{collectionDetails.date || 'Not scheduled'}</p>
                      </div>
                      <div>
                      ...
                      {collectionDetails.notes && (
                        <div className="md:col-span-2">
                          ...
                          <div className="text-sm bg-gray-50 p-3 rounded break-words">{collectionDetails.notes}</div>
                        </div>
                      )}
                    </div>
                  </CardContent>
