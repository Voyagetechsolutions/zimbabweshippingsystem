...
export const PaymentMethodSection: React.FC<PaymentMethodSectionProps> = ({
  ...
  return (
    <Card className="p-6 w-full dark:bg-gray-800 dark:border-gray-700 border-0 shadow-lg">
      <div className="mb-6">
        <h3 className="text-xl font-semibold mb-2 dark:text-white">Choose Payment Method</h3>
        <p className="text-gray-600 dark:text-gray-300">Select how you would like to pay for your shipment</p>
      </div>
      ...
      <RadioGroup 
        ...
        className="space-y-4"
      >
        <div className={`border rounded-lg p-4 transition ${selectedPaymentMethod === 'standard' 
          ? 'border-zim-green bg-green-50 dark:bg-green-900/20 dark:border-green-800'
          : 'hover:bg-gray-50 dark:hover:bg-gray-700 dark:border-gray-600'}`}
        >
          <div className="flex items-start">
            <RadioGroupItem value="standard" id="standard" className="mt-1" />
            <div className="ml-3 w-full">
              <label htmlFor="standard" className="font-medium flex items-center justify-between dark:text-white">
              ...
              <p className="text-sm text-gray-600 mt-1 mb-3 dark:text-gray-300">Pay by card or bank transfer before collection</p>
              
              {selectedPaymentMethod === 'standard' && (
                <div className="border-t pt-3 mt-2 dark:border-gray-600">
                  <RadioGroup 
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <label htmlFor="bankTransfer" className="ml-2 text-sm font-medium dark:text-gray-300">Bank Transfer</label>
                    </div>
                    
                    <div className="flex items-center">
                      <RadioGroupItem value="payLater" id="payLater" />
                      <label htmlFor="payLater" className="ml-2 text-sm font-medium dark:text-gray-300">30-Day Payment Terms (For Business Clients)</label>
                    </div>
                  </RadioGroup>
                </div>
              )}
        ...
        <div className={`border rounded-lg p-4 transition ${selectedPaymentMethod === 'cashOnCollection'
          ? 'border-zim-green bg-green-50 dark:bg-green-900/20 dark:border-green-800' 
          : 'hover:bg-gray-50 dark:hover:bg-gray-700 dark:border-gray-600'}`}
        >
          <div className="flex items-start">
            ...
            <div className="ml-3 w-full">
              <label htmlFor="cashOnCollection" className="font-medium flex items-center justify-between dark:text-white">
                <span className="flex items-center">
                ...
                {isSpecialDeal && drumQuantity > 0 ? (
                  <div className="text-right">
                    <span className="text-gray-500 line-through mr-2 dark:text-gray-400">£{totalAmount.toFixed(2)}</span>
              ...
              <p className="text-sm text-gray-600 mt-1 dark:text-gray-300">Pay with cash when your items are collected</p>
              
              {isSpecialDeal && drumQuantity > 0 && (
                <div className="mt-3 flex items-start rounded-md bg-green-100 dark:bg-green-900/40 p-2 text-sm">
                  <CheckCircle2 className="mr-2 h-4 w-4 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
        ...
        <div className={`border rounded-lg p-4 transition ${selectedPaymentMethod === 'payOnArrival' 
          ? 'border-zim-green bg-green-50 dark:bg-green-900/20 dark:border-green-800' 
          : 'hover:bg-gray-50 dark:hover:bg-gray-700 dark:border-gray-600'}`}
        >
          <div className="flex items-start">
            ...
            <div className="ml-3 w-full">
              <label htmlFor="payOnArrival" className="font-medium flex items-center justify-between dark:text-white">
                <span className="flex items-center">
              ...
              <p className="text-sm text-gray-600 mt-1 dark:text-gray-300">Pay when your shipment reaches the destination</p>
              
              <div className="mt-3 flex items-start rounded-md bg-amber-100 dark:bg-amber-900/30 p-2 text-sm">
                <AlertCircle className="mr-2 h-4 w-4 text-amber-600 dark:text-amber-400 mt-0.5 flex-shrink-0" />
      ...
      <div className="border-t mt-6 pt-6 dark:border-gray-600">
        <div className="mb-4">
          <div className="flex justify-between mb-2">
            <span className="text-gray-600 dark:text-gray-300">Subtotal:</span>
            <span className="dark:text-gray-200">£{totalAmount.toFixed(2)}</span>
          </div>
