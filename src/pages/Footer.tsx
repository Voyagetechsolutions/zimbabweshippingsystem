        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-300 mt-4">
              Reliable and affordable shipping services from the UK to Zimbabwe.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/track" className="text-gray-300 hover:text-white transition-colors">Track Shipment</Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} UK to Zimbabwe Shipping. All rights reserved.
            </p>
