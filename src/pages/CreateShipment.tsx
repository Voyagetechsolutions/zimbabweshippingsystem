...
import { CalendarIcon, Truck, MapPin, ArrowLeft } from "lucide-react";
      ...
      <main className="min-h-screen bg-gray-50 py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="mb-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mt-4 mb-2">Create New Shipment</h1>
            <p className="text-gray-600 max-w-2xl">
              Complete the form below to create a shipment from the UK to Zimbabwe. 
              Your shipment will be processed based on our monthly collection schedule.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-gray-500">Enter information about your shipment</p>
              </CardHeader>
