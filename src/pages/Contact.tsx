    ...
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative isolate overflow-hidden bg-ink py-20 text-white md:py-24">
          <img
            src={photos.vanLoaded.src}
            alt={photos.vanLoaded.alt}
          ...
          <div className="container relative z-10 mx-auto px-4 text-center">
            <span className="eyebrow !text-zim-yellow">Contact</span>
            ...
            <p className="mx-auto mt-5 max-w-2xl text-xl text-gray-300">
              Questions about a shipment, a quote, or collection? We answer fast — call,
              WhatsApp or email, whatever's easiest for you.
            </p>
          </div>
        </section>
